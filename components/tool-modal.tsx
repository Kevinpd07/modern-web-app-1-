...
interface ToolModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (name: string, url: string, id?: string) => void
  editTool?: Tool | null
}

export function ToolModal({ isOpen, onClose, onSave, editTool }: ToolModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (name.trim() && url.trim()) {
      ...
      onSave(name.trim(), formattedUrl, editTool?.id)
      setName("")
      setUrl("")
      onClose()
    }
